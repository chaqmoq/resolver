...
final class OptionalInjectedService7 {
    @OptionalInjected(arguments: "string", 1, Float(2.5), 3.2, true, Character("a"))
    var arg1: ServiceWithSixArguments?
}

final class OptionalInjectedService8 {
    @OptionalInjected(arguments: "string", 1, Float(2.5), 3.2, true, Character("a"), UInt(4))
    var arg1: ServiceWithSevenArguments?
}

final class OptionalInjectedService9 {
...
final class OptionalInjectedService11 {
    @OptionalInjected(
        arguments: "string", 1, Float(2.5), 3.2, true, Character("a"), UInt(4), UInt8(5), UInt16(6), UInt32(7)
    )
    var arg1: ServiceWithTenArguments?
}
